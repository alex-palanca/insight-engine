...
async def describe():
    ...
    logger.info("Updating %s open events with newly attached articles.", len(delta_events))
    ...
    for event_data in events:
        ...
        articles = get_event_articles(db, event_id)
        ...
        if metadata:
            create_event_metadata(db, event_id, metadata)
        else:
